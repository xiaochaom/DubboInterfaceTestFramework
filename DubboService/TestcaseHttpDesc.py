...
test_result = %s
perform_time = %s
""" % (self.caseId,self.name,self.desc,self.addBy,self.modBy,self.addTime,self.modTime,self.state,self.initTakeTime,self.recoverTakeTime,self.execTakeTime,self.totalTakeTime,
